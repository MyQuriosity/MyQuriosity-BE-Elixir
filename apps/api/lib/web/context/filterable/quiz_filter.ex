defmodule Api.Filterable.QuestionFilter do
  @moduledoc """
    A dynamic filtering module for the `Quiz` schema using `FatEcto.Builder.FatDynamicsBuildable`.
  """
  ...
  def override_buildable(_dynamics, "chapter_id", "$EQUAL", value) do
    dynamic([chapter: chapter], chapter.id == ^value)
  end

  def override_buildable(_dynamics, "topic_title", "$ILIKE", value) do
